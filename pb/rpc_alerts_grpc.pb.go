...
type AlertServiceClient interface {
	SecretAlert(ctx context.Context, in *SecretAlertRequest, opts ...grpc.CallOption) (*SecretAlertResponse, error)
}
...
func (c *alertServiceClient) SecretAlert(ctx context.Context, in *SecretAlertRequest, opts ...grpc.CallOption) (*SecretAlertResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(SecretAlertResponse)
	err := c.cc.Invoke(ctx, AlertService_SecretAlert_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AlertServiceServer interface {
	SecretAlert(context.Context, *SecretAlertRequest) (*SecretAlertResponse, error)
...
func (UnimplementedAlertServiceServer) SecretAlert(context.Context, *SecretAlertRequest) (*SecretAlertResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SecretAlert not implemented")
}
...
func _AlertService_SecretAlert_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SecretAlertRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AlertServiceServer).SecretAlert(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AlertService_SecretAlert_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AlertServiceServer).SecretAlert(ctx, req.(*SecretAlertRequest))
	}
...
var AlertService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "SecretAlert",
			Handler:    _AlertService_SecretAlert_Handler,
		},
	},
